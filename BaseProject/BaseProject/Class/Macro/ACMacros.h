...
#define kTopBarHeight           (iPhoneX?IPHONEX_TOP_BAR_H:44.f)
...
#define IPHONEX_TOP_STATUS_BAR_H 44
#define IPHONEX_TOP_BAR_H 44
#define IPHONEX_BOTTOM_H 83
#define IPHONEX_BOTTOM_BACK_BAR_H 34
...
//5.iPhoneX Plus分辨率375x812，像素1125x2436，@3x
